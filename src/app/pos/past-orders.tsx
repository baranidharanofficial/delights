...
/**
 * Today's orders, reachable from the terminal so a cashier can reprint a bill
 * or remove a mis-entered sale without leaving the counter screen for the
 * owner-only Reports section.
 *
